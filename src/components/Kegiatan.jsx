      ...
      <div data-aos="fade-up">
        ...
        <div className="h-[65vh] md:h-[75vh] w-screen md:w-[768px] p-[24px] grid grid-cols-4 gap-3 md:gap-4 text-center text-xs md:text-2xl font-bold">
          ...
          <Link
            to="/mpls"
            onClick={scrollToTop}
            className="item bg-[url('assets/kegiatan/4mpls.png')] rounded-[25px] bg-center bg-cover grid place-items-center hover:scale-105 duration-300 ease-in-out hover:saturate-150"
          >
            <span>MPLS</span>
          </Link>
          <Link
            to="/hutri"
            onClick={scrollToTop}
            className="item col-span-2 row-span-2 bg-[url('assets/kegiatan/5hutri.png')] rounded-[25px] bg-center bg-cover grid place-items-center hover:scale-105 duration-300 ease-in-out hover:saturate-150"
          >
            <span>HUT RI</span>
          </Link>
          <Link 
          to="/hutsmandela"
          onClick={scrollToTop}
          className="item col-span-2 row-span-2 bg-[url('assets/kegiatan/6huts.png')] rounded-[25px] bg-center bg-cover grid place-items-center hover:scale-105 duration-300 ease-in-out hover:saturate-150"
          >
